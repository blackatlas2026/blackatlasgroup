  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-16">
        <div className=" mb-16 border-l-4 border-red-500 pl-8">
            <h2 className="text-5xl md:text-6xl font-black mb-4 leading-none uppercase tracking-tighter">
                        Real-World <br/> <span className="text-red-500">Excellence.</span>
            </h2>
        ...
        <div className="w-full mx-auto px-6  mt-9 py-24 text-center bg-white rounded-4xl flex flex-col items-center">
            ...
            <a className="inline-block bg-red-500 text-white px-10 py-4 rounded-full text-lg font-bold hover:bg-red-600 transition-all shadow-xl shadow-red-100 " href="#">Start Shopping Now</a>
        </div>
    </div>
  );
}
