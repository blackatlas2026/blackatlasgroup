...
export default function Hero() {
      ...
      <div className="relative mx-auto max-w-7xl px-6 z-10 ">
        ...
        <div className="h-[70vh] md:h-[80vh] relative"> 
          {/* Card 1 - Scale/Fade */}
            <div 
              className={`
                absolute inset-0 min-h-[85vh] md:min-h-[90vh]
  ...
  <div className="grid gap-12 md:grid-cols-2 w-full">
    ...
    <div className="hidden md:block"></div>
          ...
          {/* Card 2 - Scale/Fade */}
         <div 
            className={`absolute inset-0   min-h-[85vh] md:min-h-[90vh] rounded-[20px_200px_20px_100px]  md:rounded-[40px_300px_40px_150px] px-8 py-10 md:py-14 md:px-16
