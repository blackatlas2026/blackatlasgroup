export default function Hero2() {
    return (<div class="relative mx-auto max-w-7xl aspect-21/10 min-h-20 organic-mask bg-slate-100 overflow-hidden group">
       ...
       <div class="absolute inset-x-0 top-1/3 z-20 flex flex-col items-center text-center px-4 -translate-y-2/5 md:-translate-y-1/2">
          <h1 class="text-white text-3xl md:text-5xl font-bold max-w-4xl leading-[1.15] mb-10 drop-shadow-2xl tracking-tight">
                              Discover Your <br class=" "/> <span className='text-red-600 font-chamberi font-semibold'> Perfect Style </span>
                              
          </h1>
          <button class=" text-sm md:text-md py-3 px-8 bg-slate-950 text-white font-bold rounded-full transition-all duration-300 hover:bg-red-600 hover:text-white hover:shadow-lg hover:shadow-red-600/30 active:scale-95 ">
                              Buy Now
          </button>
        </div>
