      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="mt-10 border-t border-white/10 pt-6 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          ...
          <div className="flex space-x-4 text-white/50">
            ...
            <a href="https://instagram.com/black-atlas" aria-label="Instagram" className="w-6 h-6 text-white/60 hover:text-white transition-colors">
            ...
            <a href="https://linkedin.com/company/black-atlas" aria-label="LinkedIn" className="w-6 h-6 text-white/60 hover:text-white transition-colors">
                <svg fill="currentColor" viewBox="0 0 24 24">
